...
npm安装：
``` bash
npm i vue3-video --save
```
yarn安装：
``` bash
yarn add vue3-video --save
```
...
## 事件示例
:::demo `vue3-video` 支持原生`video`所有事件。
...
## Props
vue3-video 支持video原生所有Attributes  [video原生属性](https://segmentfault.com/a/1190000008053507) 使用方式和props属性使用一致
...
## Events
vue3-video支持video原生所有事件  [video默认事件](https://segmentfault.com/a/1190000008053507)
...
[vue3-video](https://github.com/small-ek/vue3-video)
